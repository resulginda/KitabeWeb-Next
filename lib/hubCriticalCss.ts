...
.hub-lang-link{display:inline-flex;border-radius:8px;align-items:center;justify-content:center;opacity:.85;text-decoration:none}
.hub-lang-link.is-active{opacity:1}
.header-lang-badge{display:inline-flex;align-items:center;justify-content:center;min-width:1.65rem;height:1.2rem;padding:0 5px;border-radius:4px;background:color-mix(in srgb,var(--text-on-primary) 22%,transparent);font-size:.68rem;font-weight:700;letter-spacing:.04em;line-height:1}
.hub-lang-link.is-active .header-lang-badge{background:color-mix(in srgb,var(--text-on-primary) 38%,transparent)}
